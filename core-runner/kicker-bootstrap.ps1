...
if (-not (Test-Path $labConfigScript)) { New-Item -ItemType Directory -Path $labConfigScript -Force | Out-Null }
if (-not (Test-Path $formatScript)) { New-Item -ItemType Directory -Path $formatScript -Force | Out-Null }
