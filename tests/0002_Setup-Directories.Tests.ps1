# filepath: tests/0002_Setup-Directories.Tests.ps1
. (Join-Path $PSScriptRoot 'TestDriveCleanup.ps1')
. (Join-Path $PSScriptRoot 'helpers' 'TestHelpers.ps1')

BeforeAll {
    # Load the script under test
    $scriptPath = Join-Path $PSScriptRoot '..' '/workspaces/opentofu-lab-automation/pwsh/runner_scripts/0002_Setup-Directories.ps1'
...
Describe '0002_Setup-Directories Tests' -Tag 'Unknown' {
