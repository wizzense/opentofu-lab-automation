...
BeforeAll {
    ...
    $scriptPath = Join-Path $PSScriptRoot '..' '/workspaces/opentofu-lab-automation/pwsh/runner_scripts/0106_Install-WAC.ps1'
...
Describe '0106_Install-WAC Tests' -Tag 'Unknown' {
    ...
    Context 'Script Structure Validation' {
        ...
        It 'should define expected functions' -Skip:($SkipNonWindows) {
            Get-Command 'Get-WacRegistryInstallation' -ErrorAction SilentlyContinue | Should -Not -BeNullOrEmpty
        }
    }
