...
BeforeAll {
    ...
    $scriptPath = Join-Path $PSScriptRoot '..' '/workspaces/opentofu-lab-automation/pwsh/runner_scripts/0204_Install-Poetry.ps1'
...
Describe '0204_Install-Poetry Tests' -Tag 'Installer' {
