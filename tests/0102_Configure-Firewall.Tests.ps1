...
BeforeAll {
    ...
    $scriptPath = Join-Path $PSScriptRoot '..' '/workspaces/opentofu-lab-automation/pwsh/runner_scripts/0102_Configure-Firewall.ps1'
...
Describe '0102_Configure-Firewall Tests' -Tag 'Unknown' {
