...
try {
 ...
 Write-Host " [WARN] LabRunner module loading failed: $($_.Exception.Message)" -ForegroundColor Yellow
}
...
try {
 ...
 Write-Host " [WARN] Configuration loading failed: $($_.Exception.Message)" -ForegroundColor Yellow
}
...
foreach ($feature in $windowsFeatures) {
 ...
 Write-Host " [INFO] Would validate: $feature" -ForegroundColor Cyan
 }
}
