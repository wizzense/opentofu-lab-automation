...
try {
    ...
    Add-CheckResult -Name "Workflow Health" -Status "Warning" -Message "Error checking workflows: $($_.Exception.Message)"
}
...
Write-Host "  Overall Status: $($results.Status)" -ForegroundColor $(
