...
No more duplicate windows or external process launches for simple checks.
"""
...
class DeploymentManager:
    ...
    def setup_ui(self):
        ...
        self.deploy_btn = ttk.Button(button_frame, text="🚀 Start Deployment", command=self.start_deployment)
...
class LabAutomationGUI:
    ...
    def optimize_performance(self):
        ...
        # Set update interval for better responsiveness
