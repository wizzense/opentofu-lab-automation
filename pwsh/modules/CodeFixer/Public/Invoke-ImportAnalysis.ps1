...
function Invoke-ImportAnalysis {
 ...
 FilesWithIssues = (allIssues | Group-ObjectFile).Count
 ...
 $groupedIssues = allIssues | Group-ObjectFile
 ...
 # Summary
 $errorCount = (allIssues | Where-ObjectSeverity -eq 'Error').Count
 $warningCount = (allIssues | Where-ObjectSeverity -eq 'Warning').Count
 
 Write-Host "`n Summary:" -ForegroundColor Cyan
 Write-Host "==========" -ForegroundColor Cyan
 Write-Host "Files scanned: $($powerShellFiles.Count)" -ForegroundColor White
 Write-Host "Files with issues: $((allIssues | Group-ObjectFile).Count)" -ForegroundColor Yellow
