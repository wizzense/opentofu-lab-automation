...
function Invoke-GitControlledPatch {
    ...
    begin {
        ...
        $branchStrategy = Invoke-IntelligentBranchStrategy -PatchDescription $PatchDescription -Force:$Force
...
"@
            ...
            if ($prResult.Success) {
                ...
                if ($CreateIssueForBugFix -or ($PatchDescription -match '\b(fix|bug|error|issue|problem|broken)\b')) {
