...
"@
                    ...
                    $keepOpenComment = @"
## WARNING Pull Request Closed Without Merge
...
### Next Steps
- SYNC **Reopen PR**: If this was closed by mistake, the PR can be reopened
- [SYMBOL] **New PR**: Create a new pull request with different approach
- SEARCH **Investigation**: Determine why the PR was not suitable for merge

### Status
- **Issue Status**: [SYMBOL] **Remains Open**
