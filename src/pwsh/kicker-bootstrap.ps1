...
if (-not (Test-Path $formatScript)) {
    ...
    # DEPRECATED: LabRunner module removed due to corruption issues
    # Create basic format config locally instead of downloading deprecated LabRunner
    $basicFormatConfig = @'
# Basic formatting configuration
# LabRunner functionality replaced by PatchManager
