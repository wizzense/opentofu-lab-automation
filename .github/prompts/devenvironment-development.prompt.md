...
mode: 'agent'
tools: ['codebase']
description: 'Develop and enhance the DevEnvironment module following project standards'
---

Develop or enhance the DevEnvironment module for the OpenTofu Lab Automation project.
...
### Testing
- Generate corresponding Pester tests in the `tests/unit/modules/DevEnvironment/` directory
...
- Use appropriate module paths: `/workspaces/opentofu-lab-automation/core-runner/modules/DevEnvironment/`
