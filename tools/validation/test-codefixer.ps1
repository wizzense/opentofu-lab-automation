...
Write-Host "`n1️⃣ Testing CodeFixer Module Loading..." -ForegroundColor Yellow
try {
...
Write-Host "`n2️⃣ Testing PSScriptAnalyzer Auto-Installation..." -ForegroundColor Yellow
try {
...
Write-Host "`n3️⃣ Testing Import Analysis..." -ForegroundColor Yellow
try {
...
Write-Host "`n4️⃣ Testing LabRunner Integration..." -ForegroundColor Yellow
try {
...
Write-Host "`n5️⃣ Testing JSON Config Validation..." -ForegroundColor Yellow
try {
...
Write-Host "`n6️⃣ Testing Comprehensive Validation..." -ForegroundColor Yellow
try {
...
Write-Host "`n7️⃣ Testing Runner Scripts..." -ForegroundColor Yellow
try {
