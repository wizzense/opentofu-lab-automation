...
function Show-TagSummary {
 ...
 Write-Host " File Tagging Summary" -ForegroundColor Yellow
...
if ($ListTags) {
 ...
 if ($tags.Count -gt 0) {
 Write-Host " Tags for '$FilePath': $($tags -join ', ')" -ForegroundColor Green
 } else {
 ...
 Write-Host " Smart File Tagging System" -ForegroundColor Cyan
